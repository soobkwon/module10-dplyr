...
unique.car.manufacturers <- length(unique(manufacturers))


# Filter the data set for vehicles manufactured in 1997
cars.1997 <- manufacturers[vehicles$year == 1997]
...
hwy.gas.1997 <- vehicles[order(vehicles$hwy)]
...
vehicles$average <- mean(vehicles$city + vehicles$hwy / 2)
